...
public class Segment {
	...
	*/
	...
	public double longueur() {
		double distance = Math.sqrt((this.extremite1.getX() - this.extremite2.getX()) * (this.extremite1.getX() - this.extremite2.getX()) + (this.extremite1.getY() - this.extremite2.getY()) * (this.extremite1.getY() - this.extremite2.getY()));
		return distance;
	}
	...
	public void afficher() {
		System.out.println("[(" + this.extremite1.getX() + "," + this.extremite1.getY() + ")-(" + this.extremite2.getX() + "," + this.extremite2.getY() + ")]");
	}
