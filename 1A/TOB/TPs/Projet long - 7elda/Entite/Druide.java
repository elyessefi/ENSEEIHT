...
public class Druide implements Entite{
	public int x;
	public int y;
    ...
    public Druide(Jeu jeu, ControleClavier mouvement) {
        this(jeu, mouvement, 500, 450);
    }
    
    public Druide(Jeu jeu, ControleClavier mouvement, int x, int y) {
    ...
    private void getImage() {
        try {
            Avant_marche1 = ImageIO.read(getClass().getResourceAsStream("/ressources/druide.png"));
