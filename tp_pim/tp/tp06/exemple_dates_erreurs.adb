...
begin
    ...
    --Afficher_Deux_Positions (2); -- la fonction aficher deux positions n'est pas encore defini
    New_Line;
    ...
    --Une_Date.Jour := 15;    -- appel invalide
    --Une_Date.Mois := Mois_Suivant; -- appel invalide
    Afficher (Une_Date);
    New_Line;
